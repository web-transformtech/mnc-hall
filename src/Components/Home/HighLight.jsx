    ...
    return (
        <section className="pb-32">
            <div className="relative h-ful">
                <div className="absolute h-full bg-[#3f3f3f8c] w-full top-0 py-32 sm:py-20">
                    <div className="container mx-auto h-full">
                        ...
                        <h2 className="lg:text-[50px] lge:text-[50px] md:text-h1 mdsm:text-h1 sm:text-h4 Macondo w-[70%] mx-auto text-white font-semibold text-center">
